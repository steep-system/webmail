		...
		success: function(data,textStatus){
			if(data.code==1){
				...
				for(var i=0;i<row.length;i++){
					...
					link = '<a href="domainlist?user='+row[i].username+'&title='+row[i].realname+'" title='+row[i].username+'><img src="../../skin/default/image/img.gif" class="share-user-pic-open"/></a>'+
					'<div class="shareList_list_menu"><span class="send"><a href="javascript:void(1)"><a href="domainlist?user='+row[i].username+'&title='+row[i].realname+'" title='+row[i].username+' style="text-decoration:none;">'+uname+'</a></span></div>';
					...
					if((row[i].urights==0)||(row[i].arights==0)){
						...
						'<div class="shareList_list_menu"><span class="send" style="cursor:default;"><font color="#C0C0C0">'+uname+'</font></span></div>';
					}
